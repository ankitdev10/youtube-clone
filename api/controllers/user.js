...
export const update = async (req, res, next) => {
  // comparing userID with jwt id from verifyToken.js
...
export const subscribe = async (req, res, next) => {
  try {
    //finding jwt authticated user and pushing the subscribing user/channel into the array
    await User.findByIdAndUpdate(req.user.id, {
      $addToSet: { subscribedUsers: req.params.id },
    });
    // increasing the subscibers
